...
switch (dbType) {
	...
	case DatabaseTypeEnum.mysql:
		...
		typeOrmConnectionConfig = typeOrmMySqlOptions as TypeOrmModuleOptions;
	...
	typeOrmConnectionConfig = typeOrmPostgresOptions as TypeOrmModuleOptions;
	...
	case DatabaseTypeEnum.betterSqlite3:
		...
		typeOrmConnectionConfig = typeOrmBetterSqliteConfig as TypeOrmModuleOptions;
