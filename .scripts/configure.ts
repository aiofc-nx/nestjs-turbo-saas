...
// This script generates environment configuration files for backend applications.
...
// The list of which env maps to which file can be found in the environment configuration.
